...
class Options:
    ### model
    train_filelist: str = './filelist/train_objavser_hq.txt'
    val_filelist: str = './filelist/eval_objavser_hq.txt'
    zero123_val_filelist: str = './filelist/zero123_val_filelist_objavser_hq.txt'
    ...
    # camera radius
    cam_radius: float = 2.5 # to better use [-1, 1]^3 space
    # num workers
    num_workers: int = 8
    ...
    # resume
    resume: Optional[str] = './pretrained/objaverse_hq.ckpt'
    # batch size (per-GPU)
    batch_size: int = 4
