# This code is from InstantMesh https://github.com/TencentARC/InstantMesh
...
class RefOnlyNoisedUNet(torch.nn.Module):
    ...
    def forward(
        ...
        **kwargs
        ...
        if self.training:
            noisy_cond_lat = self.train_sched.add_noise(cond_lat, noise, timestep.to(torch.int32))
            noisy_cond_lat = self.train_sched.scale_model_input(noisy_cond_lat, timestep.to(torch.int32))
        else:
